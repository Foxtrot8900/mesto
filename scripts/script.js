...
const cardName = document.querySelector('.popup__copy-input-field-name');
const cardImage = document.querySelector('.popup__copy-input-field-job');
...
const cardCloseButton = document.querySelector('.popup__copy_container-closeicon');
const elements= document.querySelector('.elements');
const formElementCopy = document.querySelector('.popup__copy_container-form');
const overlayPopup = document.querySelector('.popup__image');
const overlayCloseIcon = document.querySelector('.popup__image_closeicon');
const picturePlace = document.querySelector('.popup__image_picture');
const captionPlace = document.querySelector('.popup__image_title');
